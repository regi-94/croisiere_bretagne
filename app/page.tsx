...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      {/* Quick Info Grid */}
<section className="max-w-6xl mx-auto -mt-12 relative z-20 px-4 pb-20">
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <Link href="/itineraire" className="group">
      <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-blue-500 hover:scale-105 transition-all cursor-pointer h-full">
        ...
        <h2 className="text-2xl font-black text-slate-900 mb-2">L'Itinéraire</h2>
        <p className="text-slate-700 leading-relaxed mb-4">
          Découvrez les zones de navigation prévues entre Lorient, Groix et les Glénan.
        </p>
    ...
    {/* Checklist Bagage (CORRIGÉE ICI) */}
    <Link href="/checklist" className="group">
      <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-emerald-500 hover:scale-105 transition-all cursor-pointer h-full">
        <Luggage className="text-emerald-500 mb-4" size={32} />
        <h2 className="text-2xl font-black text-slate-900 mb-2">Dans ton sac</h2>
        <p className="text-slate-700 leading-relaxed mb-4">
          Sacs souples uniquement. N'oublie pas ta polaire et tes lunettes de soleil.
        </p>
        <span className="text-emerald-700 font-bold group-hover:underline inline-flex items-center gap-1">
          Ouvrir la liste interactive <ChevronRight size={16} />
        </span>
      </div>
    </Link>
    ...
    <Link href="/securite" className="group">
      <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-amber-500 hover:scale-105 transition-all cursor-pointer h-full">
        ...
        <h2 className="text-2xl font-black text-slate-900 mb-2">Sécurité</h2>
        <p className="text-slate-700 leading-relaxed mb-4">
          Briefing obligatoire avant le départ. Sécurité, eau douce et électricité à bord.
        </p>
        <span className="text-amber-700 font-bold group-hover:underline inline-flex items-center gap-1">
          Lire le mémo <ChevronRight size={16} />
        </span>
      </div>
    </Link>
